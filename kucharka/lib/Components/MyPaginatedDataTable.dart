...
class MyPaginatedDataTable extends StatefulWidget {
  ...
  /// particular [MyPaginatedDataTable] widget is created; avoid creating a new
  /// [DataTableSource] with each new instance of the [MyPaginatedDataTable]
  ...
  /// [MyPaginatedDataTable] widget itself; it should be reused each time the
  /// [MyPaginatedDataTable] constructor is called.
...
/// Holds the state of a [MyPaginatedDataTable].
///
...
class MyPaginatedDataTableState extends State<MyPaginatedDataTable> {
  ...
  @override
  void didUpdateWidget(MyPaginatedDataTable oldWidget) {
